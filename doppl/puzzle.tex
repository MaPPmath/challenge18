...
\phChapterWorksheet{Endless Enigmas}{Main Puzzle 4}
...
You see, bizarre as it sounds, there's always room for another
...
Solve each problem, and then use these solutions to assign the numbers
\texttt{0} through \texttt{9} to the ten letters shown above. Use this
assignment to decode \texttt{24007042951} and you will have solved the puzzle!
