...
\begin{center}
  \begin{tikzpicture}[x=0.2in,y=0.2in]
    ...
    \node at (-1,0) {\textcolor{white}{\contour{black}{\textbf{Y}}}};
    \node at (-1,1) {\textcolor{white}{\contour{black}{\textbf{T}}}};
    \node at (-1,2) {\textcolor{white}{\contour{black}{\textbf{R}}}};
    \node at (-1,3) {\textcolor{white}{\contour{black}{\textbf{E}}}};
    \node at (-1,4) {\textcolor{white}{\contour{black}{\textbf{W}}}};
    \node at (-1,5) {\textcolor{white}{\contour{black}{\textbf{Q}}}};
    \node at (0,6) {A};
    \node at (1,6) {S};
    \node at (2,6) {D};
    \node at (3,6) {F};
...
\begin{center}
  \begin{tikzpicture}[x=0.2in,y=0.2in]
    ...
    \node at (-1,0) {\textcolor{white}{\contour{black}{\textbf{B}}}};
    \node at (-1,1) {\textcolor{white}{\contour{black}{\textbf{G}}}};
    \node at (-1,2) {\textcolor{white}{\contour{black}{\textbf{T}}}};
    \node at (-1,3) {\textcolor{white}{\contour{black}{\textbf{N}}}};
    \node at (-1,4) {\textcolor{white}{\contour{black}{\textbf{H}}}};
    \node at (-1,5) {\textcolor{white}{\contour{black}{\textbf{Y}}}};
    \node at (0,6) {Q};
    \node at (1,6) {A};
    \node at (2,6) {Z};
    \node at (3,6) {E};
  ...
  \begin{tikzpicture}[x=0.2in,y=0.2in]
    ...
    \node at (-1,0) {\textcolor{white}{\contour{black}{\textbf{J}}}};
    \node at (-1,1) {\textcolor{white}{\contour{black}{\textbf{U}}}};
    \node at (-1,2) {\textcolor{white}{\contour{black}{\textbf{G}}}};
    \node at (-1,3) {\textcolor{white}{\contour{black}{\textbf{F}}}};
    \node at (-1,4) {\textcolor{white}{\contour{black}{\textbf{D}}}};
    \node at (-1,5) {\textcolor{white}{\contour{black}{\textbf{S}}}};
    \node at (0,6) {P};
    \node at (1,6) {O};
    \node at (2,6) {I};
    \node at (3,6) {H};
  ...
  \begin{tikzpicture}[x=0.2in,y=0.2in]
    ...
    \node at (-1,0) {\textcolor{white}{\contour{black}{\textbf{C}}}};
    \node at (-1,1) {\textcolor{white}{\contour{black}{\textbf{D}}}};
    \node at (-1,2) {\textcolor{white}{\contour{black}{\textbf{E}}}};
    \node at (-1,3) {\textcolor{white}{\contour{black}{\textbf{V}}}};
    \node at (-1,4) {\textcolor{white}{\contour{black}{\textbf{F}}}};
    \node at (-1,5) {\textcolor{white}{\contour{black}{\textbf{R}}}};
    \node at (0,6) {B};
    \node at (1,6) {G};
    \node at (2,6) {T};
    \node at (3,6) {N};
  ...
  \begin{tikzpicture}[x=0.2in,y=0.2in]
    ...
    \draw[fill=black] (4,2) circle (0.4);
    \draw[fill=black] (4,3) circle (0.4);
    \node at (-1,0) {\textcolor{white}{\contour{black}{\textbf{K}}}};
    \node at (-1,1) {\textcolor{white}{\contour{black}{\textbf{J}}}};
    \node at (-1,2) {\textcolor{white}{\contour{black}{\textbf{H}}}};
    \node at (-1,3) {\textcolor{white}{\contour{black}{\textbf{G}}}};
    \node at (-1,4) {\textcolor{white}{\contour{black}{\textbf{F}}}};
    \node at (-1,5) {\textcolor{white}{\contour{black}{\textbf{D}}}};
    \node at (-1,6) {\textcolor{white}{\contour{black}{\textbf{S}}}};
    \node at (-1,7) {\textcolor{white}{\contour{black}{\textbf{A}}}};
    \node at (0,8) {M};
    \node at (1,8) {N};
    \node at (2,8) {B};
    \node at (3,8) {V};
  ...
  \begin{tikzpicture}[x=0.2in,y=0.2in]
    ...
    \node at (-1,0) {\textcolor{white}{\contour{black}{\textbf{Y}}}};
    \node at (-1,1) {\textcolor{white}{\contour{black}{\textbf{H}}}};
    \node at (-1,2) {\textcolor{white}{\contour{black}{\textbf{N}}}};
    \node at (-1,3) {\textcolor{white}{\contour{black}{\textbf{T}}}};
    \node at (-1,4) {\textcolor{white}{\contour{black}{\textbf{G}}}};
    \node at (-1,5) {\textcolor{white}{\contour{black}{\textbf{B}}}};
    \node at (-1,6) {\textcolor{white}{\contour{black}{\textbf{R}}}};
    \node at (-1,7) {\textcolor{white}{\contour{black}{\textbf{F}}}};
    \node at (0,8) {U};
    \node at (1,8) {J};
    \node at (2,8) {M};
    \node at (3,8) {I};
  ...
  \begin{tikzpicture}[x=0.2in,y=0.2in]
    ...
    \node at (-1,0) {\textcolor{white}{\contour{black}{\textbf{L}}}};
    \node at (-1,1) {\textcolor{white}{\contour{black}{\textbf{K}}}};
    \node at (-1,2) {\textcolor{white}{\contour{black}{\textbf{M}}}};
    \node at (-1,3) {\textcolor{white}{\contour{black}{\textbf{J}}}};
    \node at (-1,4) {\textcolor{white}{\contour{black}{\textbf{N}}}};
    \node at (-1,5) {\textcolor{white}{\contour{black}{\textbf{H}}}};
    \node at (-1,6) {\textcolor{white}{\contour{black}{\textbf{B}}}};
    \node at (-1,7) {\textcolor{white}{\contour{black}{\textbf{G}}}};
    \node at (0,8) {I};
    \node at (1,8) {U};
    \node at (2,8) {Y};
    \node at (3,8) {T};
  ...
  \begin{tikzpicture}[x=0.2in,y=0.2in]
    ...
    \node at (-1,0) {\textcolor{white}{\contour{black}{\textbf{W}}}};
    \node at (-1,1) {\textcolor{white}{\contour{black}{\textbf{E}}}};
    \node at (-1,2) {\textcolor{white}{\contour{black}{\textbf{R}}}};
    \node at (-1,3) {\textcolor{white}{\contour{black}{\textbf{T}}}};
    \node at (-1,4) {\textcolor{white}{\contour{black}{\textbf{Y}}}};
    \node at (-1,5) {\textcolor{white}{\contour{black}{\textbf{U}}}};
    \node at (-1,6) {\textcolor{white}{\contour{black}{\textbf{I}}}};
    \node at (-1,7) {\textcolor{white}{\contour{black}{\textbf{O}}}};
    \node at (-1,8) {\textcolor{white}{\contour{black}{\textbf{P}}}};
    \node at (-1,9) {\textcolor{white}{\contour{black}{\textbf{L}}}};
    \node at (0,10) {K};
    \node at (1,10) {J};
    \node at (2,10) {H};
    \node at (3,10) {G};
  ...
  \begin{tikzpicture}[x=0.2in,y=0.2in]
    ...
    \node at (-1,0) {\textcolor{white}{\contour{black}{\textbf{Y}}}};
    \node at (-1,1) {\textcolor{white}{\contour{black}{\textbf{H}}}};
    \node at (-1,2) {\textcolor{white}{\contour{black}{\textbf{U}}}};
    \node at (-1,3) {\textcolor{white}{\contour{black}{\textbf{J}}}};
    \node at (-1,4) {\textcolor{white}{\contour{black}{\textbf{I}}}};
    \node at (-1,5) {\textcolor{white}{\contour{black}{\textbf{K}}}};
    \node at (-1,6) {\textcolor{white}{\contour{black}{\textbf{O}}}};
    \node at (-1,7) {\textcolor{white}{\contour{black}{\textbf{L}}}};
    \node at (-1,8) {\textcolor{white}{\contour{black}{\textbf{P}}}};
    \node at (-1,9) {\textcolor{white}{\contour{black}{\textbf{M}}}};
    \node at (0,10) {Q};
    \node at (1,10) {A};
    \node at (2,10) {W};
    \node at (3,10) {S};
  ...
  \begin{tikzpicture}[x=0.2in,y=0.2in]
    ...
    \node at (-1,6) {\textcolor{white}{\contour{black}{\textbf{B}}}};
    \node at (-1,7) {\textcolor{white}{\contour{black}{\textbf{G}}}};
    \node at (-1,8) {\textcolor{white}{\contour{black}{\textbf{F}}}};
    \node at (-1,9) {\textcolor{white}{\contour{black}{\textbf{V}}}};
    \node at (0,10) {I};
    \node at (1,10) {U};
    \node at (2,10) {Y};
    \node at (3,10) {T};
...
%     \foreach \x in {0,...,12}
%     \node at (\x * 0.58, 7.3){\contour{black}{\textbf{\}AlphAlph{\x + 14}}};
%     \foreach \x in {0,...,12}
%     \node at (-0.25, \x * 0.58){\contour{black}{\textbf{\}textcolor{white}{\AlphAlph{13 -
%           \x}}}};
%     % right board coordinate system
%   \foreach \x in {0,...,12} \node at (8.5 + \x * 0.58,
%   7.3){\contour{black}{\textbf{\}AlphAlph{\x + 14}}}; \foreach \x in {0,...,12} \node at
%   (8.2, \x * 0.58){\contour{black}{\textbf{\}textcolor{white}{\AlphAlph{13 - \x}}}};
%   \end{tikzpicture}
%   }
%
%   \vfill
...
%     % right board coordinate system
%     \foreach \x in {0,...,12}
%     \node at (8.5 + \x * 0.58, 7.3){\contour{black}{\textbf{\}AlphAlph{\x + 14}}};
%     \foreach \x in {0,...,12}
%     \node at (8, \x * 0.58){\contour{black}{\textbf{\}textcolor{white}{\AlphAlph{13 - \x}}}};
%   \end{tikzpicture}
%   }
%
%   \vfill
...
%     % left board coordinate system
%     \foreach \x in {0,...,12}
%     \node at (0.35 + \x * 0.58, 7.6){\contour{black}{\textbf{\}AlphAlph{\x + 14}}};
%     \foreach \x in {0,...,12}
%     \node at (-0.25, \x * 0.58){\contour{black}{\textbf{\}textcolor{white}{\AlphAlph{13 -
%           \x}}}};
%     % right board coordinate system
%     \foreach \x in {0,...,12}
%     \node at (8.7 + \x * 0.58, 7.5){\contour{black}{\textbf{\}AlphAlph{\x + 14}}};
%     \foreach \x in {0,...,12}
%     \node at (8.2, \x * 0.58){\contour{black}{\textbf{\}textcolor{white}{\AlphAlph{13 - \x}}}};
%   \end{tikzpicture}
%   }
%
%   \vfill
...
%     % left board coordinate system
%     \foreach \x in {0,...,12}
%     \node at (0.3 + \x * 0.58, 7.5){\contour{black}{\textbf{\}AlphAlph{\x + 14}}};
%     \foreach \x in {0,...,12}
%     \node at (-0.25, \x * 0.58){\contour{black}{\textbf{\}textcolor{white}{\AlphAlph{13 -
%           \x}}}};
%     % right board coordinate system
%     \foreach \x in {0,...,12}
%     \node at (8.7 + \x * 0.58, 7.3){\contour{black}{\textbf{\}AlphAlph{\x + 14}}};
%     \foreach \x in {0,...,12}
%     \node at (8.2, \x * 0.58){\contour{black}{\textbf{\}textcolor{white}{\AlphAlph{13 - \x}}}};
%   \end{tikzpicture}
%   }
