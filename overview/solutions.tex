...
\phSection{Opening Puzzle - The Kantor Region}

TODO

\phSection{Main Puzzle 1 - Go For It}
...
\phSection{Metapuzzle - Route to Victory}

The four Dojo Master \mappMobimon{} are determined by comparing the
...
\begin{enumerate}
  ...
  \item \texttt{gLowmage} (Gary, originally ranked 5)
  \item \texttt{arIafire} (DM2, originally ranked 2)
  \item \texttt{zomTreed} (DM3, originally ranked 3)
  \item \texttt{burnEzam} (DM1, originally ranked 1)
  \item \texttt{thundOra} (DM4, originally ranked 4)
  \item \texttt{squidiNy} (Misty, originally ranked 6)
